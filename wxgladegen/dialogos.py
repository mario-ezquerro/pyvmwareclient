...
# -*- coding: US-ASCII -*-
#
# generated by wxGlade 0.7.1 on Wed Sep  6 09:22:48 2017
#
...
class Dialogo_texto(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        wx.Dialog.__init__(self, *args, **kwds)
        self.salida_texto = wx.TextCtrl(self, wx.ID_ANY, "", style=wx.BORDER_NONE | wx.TE_AUTO_URL | wx.TE_MULTILINE | wx.TE_PROCESS_ENTER)
    ...
    def __set_properties(self):
        ...
        self.SetSize((714, 258))
        self.salida_texto.SetMinSize((702, 176))
        # end wxGlade

    def __do_layout(self):
        # begin wxGlade: Dialogo_texto.__do_layout
        sizer_1 = wx.FlexGridSizer(2, 1, 0, 0)
        sizer_1.Add(self.salida_texto, 0, wx.ALL, 4)
