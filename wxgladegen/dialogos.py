...
# -*- coding: US-ASCII -*-
#
# generated by wxGlade not found on Fri Jul 21 17:11:42 2017
#
...
class Dialogo_acceso_vcenter(wx.Dialog):
    ...
    def __do_layout(self):
        ...
        vcenter = wx.StaticText(self, wx.ID_ANY, "Vcenter/esxi:")
        ...
        sizer_6.Add(self.button_Connect, 0, 0, 0)
        grid_sizer_5.Add(sizer_6, 4, wx.ALIGN_RIGHT | wx.ALL, 2)
