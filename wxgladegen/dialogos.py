...
# -*- coding: US-ASCII -*-
#
# generated by wxGlade not found on Mon Jan 15 09:39:55 2018
#
...
class Dialogo_texto(wx.Dialog):
    ...
    def __do_layout(self):
        ...
        sizer_1 = wx.StaticBoxSizer(wx.StaticBox(self, wx.ID_ANY, "Information"), wx.VERTICAL)
...
class MyFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.list_ctrl_1 = wx.ListCtrl(self, wx.ID_ANY, style=wx.LC_EDIT_LABELS | wx.LC_LIST | wx.LC_REPORT | wx.LC_VIRTUAL)
    ...
    def __set_properties(self):
        ...
        self.button_buscar.SetMinSize((85, 34))
    ...
    def __do_layout(self):
        ...
        sizer_4.Add(self.list_ctrl_1, 0, wx.ALL | wx.EXPAND, 3)
