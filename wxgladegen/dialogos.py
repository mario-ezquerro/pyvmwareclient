...
# -*- coding: US-ASCII -*-
#
# generated by wxGlade 0.7.1 on Thu May 24 10:58:46 2018
#
...
class Dialogo_user_pass(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        self.label_3 = wx.StaticText(self, wx.ID_ANY, "Usuario:", style=wx.ALIGN_RIGHT)
        self.usuario = wx.TextCtrl(self, wx.ID_ANY, "")
        self.label_4 = wx.StaticText(self, wx.ID_ANY, "Password:", style=wx.ALIGN_RIGHT)
