...
# -*- coding: US-ASCII -*-
#
# generated by wxGlade 0.7.1 on Fri Feb  2 13:41:19 2018
#
...
class Dialogo_acceso_vcenter(wx.Dialog):
    ...
    def __do_layout(self):
        ...
        sizer_6.Add(grid_sizer_5, 1, wx.ADJUST_MINSIZE | wx.ALIGN_CENTER | wx.ALIGN_RIGHT | wx.ALL, 10)
        grid_sizer_6.Add(self.button_Exit, 0, wx.RIGHT, 3)
        grid_sizer_6.Add(self.button_Connect, 0, 0, 0)
        sizer_6.Add(grid_sizer_6, 1, wx.ADJUST_MINSIZE | wx.ALIGN_RIGHT | wx.ALL | wx.FIXED_MINSIZE, 4)
...
class Dialogo_host(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        kwds["style"] = wx.DEFAULT_DIALOG_STYLE | wx.MAXIMIZE_BOX | wx.RESIZE_BORDER
        wx.Dialog.__init__(self, *args, **kwds)
        self.list_ctrl_host = wx.ListCtrl(self, wx.ID_ANY, style=wx.BORDER_DEFAULT | wx.BORDER_SUNKEN | wx.LC_HRULES | wx.LC_REPORT | wx.LC_VRULES)
        self.bnt_salida_ok = wx.Button(self, wx.ID_OK, "OK", style=wx.BU_BOTTOM)
...
class Dialog_list(wx.Dialog):
    def __init__(self, *args, **kwds):
        ...
        kwds["style"] = wx.DEFAULT_DIALOG_STYLE | wx.MAXIMIZE_BOX | wx.RESIZE_BORDER
        wx.Dialog.__init__(self, *args, **kwds)
        self.list_ctrl = wx.ListCtrl(self, wx.ID_ANY, style=wx.BORDER_DEFAULT | wx.BORDER_SUNKEN | wx.LC_HRULES | wx.LC_REPORT | wx.LC_VRULES)
        self.bnt_salida_ok = wx.Button(self, wx.ID_OK, "OK", style=wx.BU_BOTTOM)
    ...
    def __do_layout(self):
        ...
        sizer_7 = wx.BoxSizer(wx.VERTICAL)
        sizer_7.Add(self.list_ctrl, 1, wx.ALL | wx.EXPAND, 5)
        sizer_7.Add(self.bnt_salida_ok, 0, wx.ALIGN_RIGHT | wx.RIGHT | wx.SHAPED, 5)
        self.SetSizer(sizer_7)
        sizer_7.Fit(self)
        self.Layout()
