...
# -*- coding: US-ASCII -*-
#
# generated by wxGlade not found on Tue Jul 18 10:15:52 2017
#
...
class _152301206_Dialogo_acceso_vcenter(wx.Dialog):
    def __init__(self, *args, **kwds):
        # begin wxGlade: _152301206_Dialogo_acceso_vcenter.__init__
        wx.Dialog.__init__(self, *args, **kwds)
    ...
    def __set_properties(self):
        # begin wxGlade: _152301206_Dialogo_acceso_vcenter.__set_properties
        self.SetTitle("dialog")
        self.SetSize((446, 210))
        self.SetFocus()
    ...
    def __do_layout(self):
        # begin wxGlade: _152301206_Dialogo_acceso_vcenter.__do_layout
        grid_sizer_5 = wx.FlexGridSizer(5, 2, 4, 10)
        vcenter = wx.StaticText(self, -1, "Vcenter/esxi:")
        vcenter.SetToolTip("Puedes conectarte a un esxi o a un Vcenter")
        grid_sizer_5.Add(vcenter, 0, wx.ALIGN_RIGHT | wx.ALL | wx.EXPAND, 2)
        grid_sizer_5.Add(self.text_ctrl_1, 0, 0, 0)
        login = wx.StaticText(self, -1, "Login:")
        login.SetToolTip("Tu usuario de acceso.")
        grid_sizer_5.Add(login, 0, wx.ALL, 4)
        grid_sizer_5.Add(self.text_ctrl_2, 0, 0, 0)
        password = wx.StaticText(self, -1, "Password:")
        password.SetToolTip("Hay que explicarlo?")
        grid_sizer_5.Add(password, 0, wx.ALL, 4)
        grid_sizer_5.Add(self.text_ctrl_3, 0, 0, 0)
        puerto = wx.StaticText(self, -1, "Puerto:")
        puerto.SetToolTip("Por defecto el puerto es el 443")
        grid_sizer_5.Add(puerto, 0, wx.ALL, 4)
        grid_sizer_5.Add(self.text_ctrl_4, 0, 0, 0)
        grid_sizer_5.Add(self.Exit, 0, wx.ALL, 4)
        grid_sizer_5.Add(self.Connect, 0, wx.ALL, 4)
        self.SetSizer(grid_sizer_5)
        self.Layout()
        # end wxGlade

# end of class _152301206_Dialogo_acceso_vcenter
